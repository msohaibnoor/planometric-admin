...
function* updateDataRequest({ payload }) {
    ...
    let data = {
        ...
        planometricTrialFee: payload.planometricTrialFee,
        stripeText: payload.stripeText,
        trialPlanInstruction1: payload.trialPlanInstruction1,
        trialPlanInstruction2: payload.trialPlanInstruction2,
        trialPlanInstruction3: payload.trialPlanInstruction3,
        ...
        popupMessageTryAndSave1: payload.popupMessageTryAndSave1,
        popupMessageTryAndSave2: payload.popupMessageTryAndSave2,
        popupMessageTryAndSave3: payload.popupMessageTryAndSave3,
